    ...
    it('should handle multiple payment methods', async () => {
      const multiPaymentData = {
        ...
        paymentMethods: [
          ...
          { type: 'card', amount: 50000 },
          { type: 'digital_wallet', amount: 29500 }
        ],
      };
      ...
      expect(paymentMethods).toEqual(expect.arrayContaining([
        expect.objectContaining({ type: 'cash', amount: 80000 }),
        expect.objectContaining({ type: 'card', amount: 50000 }),
        expect.objectContaining({ type: 'digital_wallet', amount: 29500 }),
      ]));
    });
